...
class EdoMoveGroupInterface(object):
    ...
    def __init__(self, home=[0, 0, 0, 0, 0, 1.57 / 2]) -> None:
        ...
        self.marker_dict = {
            ...
            "I" : { 'xyz' : [ 0.240, 0.175, 0.9], 'rpy' : [-180, -4.5, 168]},
            "J" : { 'xyz' : [ 0.175, 0.240, 0.9], 'rpy' : [-180, -4.5, -174]},
            "K" : { 'xyz' : [ 0.090, 0.285, 0.9], 'rpy' : [-180, -4.5, -155]},
            "L" : { 'xyz' : [ 0.000, 0.300, 0.9], 'rpy' : [-180, -4.5, -138]},
            "O" : { 'xyz' : [ 0.245, -0.175, 0.9], 'rpy' : [-180, -4.5, 100]},
            "P" : { 'xyz' : [ 0.180, -0.240, 0.9], 'rpy' : [-180, -4.5, 82]},
            "Q" : { 'xyz' : [ 0.095, -0.285, 0.9], 'rpy' : [-180, -4.5, 64]},
            "R" : { 'xyz' : [ 0.000, -0.300, 0.9], 'rpy' : [-180, -4.5, 46]},
        ...
        '''for key in self.marker_dict:
            self.go_to_xyz_rpy(self.marker_dict[key]['xyz'], self.marker_dict[key]['rpy'])
            rospy.sleep(1)'''
